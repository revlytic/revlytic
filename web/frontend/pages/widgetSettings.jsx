...
const  defaultSettings={
  ...
  additionalSubscriptionDetails:"Subscribe with Revlytic. Choose an option that best meets your needs. Set up regularly scheduled deliveries that are automatically sent to you. Manage your subscription anytime.",
  ...
  return (
    <Spin spinning={loader} size="large" tip="Loading...">
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("Purchase Options Text is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("Purchase Options Text is required!");
                        }
                ...
                <Form.Item
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("One-Time Purchase Text is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("One-Time Purchase Text is required!");
                        }
                ...
                <Form.Item
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("Subscription Options Text is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("Subscription Options Text is required!");
                        }
        ...
        <Form.Item
          ...
          rules={[
...

            {
              validator: (rule, value) => {
                if (!value) {
                  return Promise.reject("Delivery Frequency Options Text is required!");
                } else if (value.trim() === "") {
                  return Promise.reject("Delivery Frequency Options Text is required!");
                }
     ...
     />
        ...
        >
          <Checkbox  onChange={(e) =>
              handleInputChange("showPredefinedDeliveryFrequencies", e.target.checked)
            } />
        </Form.Item>
      </div>
                ...
                <Form.Item
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("Subscription Details Text is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("Subscription Details Text is required!");
                        }
                ...
                <Form.Item
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("Additional Subscription Details is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("Additional Subscription Details is required!");
                        }
                ...
                <Form.Item
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("Month Frequency Text is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("Month Frequency Text is required!");
                        }
                ...
                <Form.Item
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("Year Frequency Text is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("Year Frequency Text is required!");
                        }
                ...
                <Form.Item
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("Day Frequency Text is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("Day Frequency Text is required!");
                        }
                ...
                <Form.Item
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("Week Frequency Text is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("Week Frequency Text is required!");
                        }
              ...
              <div className="revlytic widget-items">
                <Form.Item
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("Billing Frequency Text is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("Billing Frequency Text is required!");
                        }
                ...
                >
                  <Input
                    onChange={(e) =>
                      handleInputChange("billingFrequencyText", e.target.value)
                    }
                  />
                </Form.Item>
                ...
                <Form.Item
                  ...
                  rules={[
...

                    {
                      validator: (rule, value) => {
                        if (!value) {
                          return Promise.reject("Delivery Frequency Text is required!");
                        } else if (value.trim() === "") {
                          return Promise.reject("Delivery Frequency Text is required!");
                        }
                ...
                >
                  <Input
                    onChange={(e) =>
                      handleInputChange("deliveryFrequencyText", e.target.value)
                    }
                  />
                </Form.Item>
              </div>
                      ...
                      <div className="revlytic delivery-billing-section">
                        <p>
                          ...
                          <span id="revlytic-billing-frequency">
                            : {formValues.everyText} 1 {formValues.monthFrequencyText}
                          </span>{" "}
                        </p>
