...
//    const {billingPlan,billingPlanDate,check,setRecurringRevenue,planBuyDate,recurringRevenue}=useAPI()
//    useEffect(async()=>{
...
//            if (filtered) {
//       // console.log("31jan",planBuyDate)
     
      
//      let  range= (!billingPlan || billingPlan=='') ? new Date(new Date().getTime() - 30 * 24 * 60 * 60 * 1000) : billingPlan == 'free'   ? getFreePlanDate(new Date(),new Date(planBuyDate))   : planBuyDate;
...
//   const finaldate = new Date(today.getTime() - remaining * 24 * 60 * 60 * 1000)
//   // console.log("jkkkk",finaldate)
//   return finaldate
//    }
//    else
//    {
//         const finaldate = new Date(today.getTime() - daysDifference * 24 * 60 * 60 * 1000)
//   return finaldate
...
//             { planUpdate  && <Alert className="revlytic-billing-plans-warning" banner closable message="Revenue cap for the monthly plan reached, please upgrade." type="warning"  />}
             
//       { planUpdate ==false ? <Outlet  /> : <Billing setPlanUpdate={setPlanUpdate} setActiveContactRoute={props.setActiveContactRoute}/>}
//             </div>
//           </div>
//         </div>
//       </div>
